...
<Form validationBehavior="aria" onSubmit={handleCredentialsSubmit}>
  <TextField isRequired name="email" type="email">
    ...
    <Input placeholder="usuario@bioalergia.cl" value={email} />
  </TextField>

  <TextField isRequired name="mfaCode" type="text">
    <Label>Código de seguridad</Label>
    <Input maxLength={6} pattern="[0-9]*" placeholder="000000" value={mfaCode} />
  </TextField>
</Form>
```
...
<Form onSubmit={handleSubmit} validationBehavior="aria">
  ...
  <TextField isInvalid={Boolean(error?.includes("RUT"))} isRequired name="rut">
    <Label>RUT</Label>
    <Input placeholder="12.345.678-9" value={profile.rut} />
...
<Form validationBehavior="aria" onSubmit={handleCreate}>
  <TextField id="category-name">
    ...
    <Input placeholder="Ej: Antibióticos" value={newCategoryName} />
  </TextField>
