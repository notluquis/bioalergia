...
import { TimesheetAuditCalendar, EmployeeAuditSelector } from "@/features/hr/timesheets-audit/components";
        ...
        <div className="space-y-6">
          <div className="grid gap-4 md:grid-cols-3">
            <div className="surface-recessed px-5 py-4">
              ...
              {formattedRangeSummary && <p className="mt-1 text-xs text-base-content/60">{formattedRangeSummary}</p>}
            </div>
            <div className="surface-recessed px-5 py-4">
              ...
              <p className="mt-1 text-xs text-base-content/60">Sólo contabilizamos conflictos reales</p>
            </div>
            <div className="surface-recessed px-5 py-4">
              ...
              <p className="mt-1 text-xs text-base-content/60">Excluyendo combinaciones enfermero + TENS</p>
            </div>
          </div>
