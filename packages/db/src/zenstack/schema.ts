        ...
        DTEPeriod: {
            ...
            fields: {
                ...
                period: {
                    ...
                    type: "String",
                    unique: true,
                    attributes: [{ name: "@unique" }, { name: "@db.VarChar", args: [{ name: "x", value: ExpressionUtils.literal(6) }] }]
                },
                year: {
                    name: "year",
                    type: "Int"
                ...
                purchaseCount: {
                    name: "purchaseCount",
                    type: "Int",
                    attributes: [{ name: "@default", args: [{ name: "value", value: ExpressionUtils.literal(0) }] }, { name: "@map", args: [{ name: "name", value: ExpressionUtils.literal("purchase_count") }] }],
                    default: 0
                },
                saleCount: {
                    name: "saleCount",
                    type: "Int",
                    attributes: [{ name: "@default", args: [{ name: "value", value: ExpressionUtils.literal(0) }] }, { name: "@map", args: [{ name: "name", value: ExpressionUtils.literal("sale_count") }] }],
                    default: 0
                },
                totalPurchases: {
                    name: "totalPurchases",
                    type: "Decimal",
                    attributes: [{ name: "@default", args: [{ name: "value", value: ExpressionUtils.literal(0) }] }, { name: "@map", args: [{ name: "name", value: ExpressionUtils.literal("total_purchases") }] }, { name: "@db.Decimal", args: [{ name: "p", value: ExpressionUtils.literal(18) }, { name: "s", value: ExpressionUtils.literal(2) }] }],
                    default: 0
                },
                totalSales: {
                    name: "totalSales",
                    type: "Decimal",
                    attributes: [{ name: "@default", args: [{ name: "value", value: ExpressionUtils.literal(0) }] }, { name: "@map", args: [{ name: "name", value: ExpressionUtils.literal("total_sales") }] }, { name: "@db.Decimal", args: [{ name: "p", value: ExpressionUtils.literal(18) }, { name: "s", value: ExpressionUtils.literal(2) }] }],
                    default: 0
                },
                importedAt: {
                    name: "importedAt",
                    type: "DateTime",
                    optional: true,
                    attributes: [{ name: "@map", args: [{ name: "name", value: ExpressionUtils.literal("imported_at") }] }]
                },
                createdAt: {
                    name: "createdAt",
                    type: "DateTime",
            ...
            attributes: [
                ...
                { name: "@@index", args: [{ name: "fields", value: ExpressionUtils.array("Int", [ExpressionUtils.field("year"), ExpressionUtils.field("month")]) }] },
        ...
        DTEPurchaseDetail: {
            ...
            fields: {
                ...
                documentDate: {
                    name: "documentDate",
                    type: "DateTime",
                    attributes: [{ name: "@map", args: [{ name: "name", value: ExpressionUtils.literal("document_date") }] }]
                },
                receiptDate: {
                    name: "receiptDate",
                    type: "DateTime",
                    attributes: [{ name: "@map", args: [{ name: "name", value: ExpressionUtils.literal("receipt_date") }] }]
                },
                acknowledgeDate: {
                    name: "acknowledgeDate",
                    type: "DateTime",
                    optional: true,
                    attributes: [{ name: "@map", args: [{ name: "name", value: ExpressionUtils.literal("acknowledge_date") }] }]
                },
                period: {
                    name: "period",
                    type: "String",
        ...
        DTESaleDetail: {
            ...
            fields: {
                ...
                receiptAcknowledgeDate: {
                    ...
                    type: "DateTime",
                    optional: true,
                    attributes: [{ name: "@map", args: [{ name: "name", value: ExpressionUtils.literal("receipt_acknowledge_date") }] }]
                },
                claimDate: {
                    name: "claimDate",
                    type: "DateTime",
                    optional: true,
                    attributes: [{ name: "@map", args: [{ name: "name", value: ExpressionUtils.literal("claim_date") }] }]
                },
                period: {
                    name: "period",
                    type: "String",
        ...
        HaulmerSyncLog: {
            ...
            fields: {
                ...
                csvHash: {
                    ...
                    type: "String",
                    optional: true,
                    attributes: [{ name: "@db.VarChar", args: [{ name: "x", value: ExpressionUtils.literal(64) }] }]
                },
                csvSize: {
                    name: "csvSize",
                    type: "Int",
                ...
                status: {
                    name: "status",
                    type: "String",
                    attributes: [{ name: "@db.VarChar", args: [{ name: "x", value: ExpressionUtils.literal(20) }] }, { name: "@default", args: [{ name: "value", value: ExpressionUtils.literal("pending") }] }],
                    default: "pending"
                },
                errorMessage: {
                    name: "errorMessage",
                ...
                syncedAt: {
                    name: "syncedAt",
                    type: "DateTime",
                    attributes: [{ name: "@default", args: [{ name: "value", value: ExpressionUtils.call("now") }] }, { name: "@map", args: [{ name: "name", value: ExpressionUtils.literal("synced_at") }] }],
                    default: ExpressionUtils.call("now")
                },
                createdAt: {
                    name: "createdAt",
        ...
        HaulmerAuthToken: {
            ...
            fields: {
                ...
                email: {
                    name: "email",
                    type: "String",
                    attributes: [{ name: "@db.VarChar", args: [{ name: "x", value: ExpressionUtils.literal(255) }] }]
                },
                jwtToken: {
                    name: "jwtToken",
                    type: "String",
                ...
                workspaceId: {
                    ...
                    type: "String",
                    optional: true,
                    attributes: [{ name: "@db.VarChar", args: [{ name: "x", value: ExpressionUtils.literal(100) }] }]
                },
                issuedAt: {
                    name: "issuedAt",
                    type: "DateTime",
                    attributes: [{ name: "@map", args: [{ name: "name", value: ExpressionUtils.literal("issued_at") }] }]
                },
                expiresAt: {
                    name: "expiresAt",
                    type: "DateTime",
                ...
                capturedBy: {
                    ...
                    type: "Int",
                    optional: true,
                    attributes: [{ name: "@map", args: [{ name: "name", value: ExpressionUtils.literal("captured_by") }] }]
                },
                createdAt: {
                    name: "createdAt",
                    type: "DateTime",
            ...
            attributes: [
                ...
                { name: "@@map", args: [{ name: "name", value: ExpressionUtils.literal("haulmer_auth_tokens") }] }
            ],
            idFields: ["id"],
            uniqueFields: {
                id: { type: "String" },
