    ...
    models = {
        ...
        SyncLog: {
            ...
            fields: {
                ...
                mercadopagoImportChanges: {
                    name: "mercadopagoImportChanges",
                    type: "MercadoPagoImportChange",
                    array: true,
        ...
        MercadoPagoImportChange: {
            name: "MercadoPagoImportChange",
            fields: {
                id: {
                    name: "id",
                    type: "BigInt",
                ...
                syncLog: {
                    name: "syncLog",
                    type: "SyncLog",
                    relation: { opposite: "mercadopagoImportChanges", fields: ["syncLogId"], references: ["id"], onDelete: "Cascade" }
                }
            },
            idFields: ["id"],
            uniqueFields: {
