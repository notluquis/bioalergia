    ...
    ImmunotherapyDoseStage: {
      ...
      fields: {
        ...
        productId: {
          name: "productId",
          type: "Int",
          foreignKeyFor: ["product"] as readonly string[],
        },
        label: {
          name: "label",
          type: "String",
    ...
    CompanyContact: {
      ...
      fields: {
        ...
        companyId: {
          name: "companyId",
          type: "Int",
          foreignKeyFor: ["company"] as readonly string[],
        },
        personId: {
          name: "personId",
          type: "Int",
    ...
    QuoteItem: {
      ...
      fields: {
        ...
        quoteId: {
          name: "quoteId",
          type: "Int",
          foreignKeyFor: ["quote"] as readonly string[],
        },
        productId: {
          name: "productId",
          type: "Int",
    ...
    ExamReport: {
      ...
      fields: {
        ...
        conclusionTemplateId: {
          ...
          type: "Int",
          optional: true,
          foreignKeyFor: ["conclusionTemplate"] as readonly string[],
        },
        reagents: {
          name: "reagents",
          type: "String",
        ...
        createdBy: {
          ...
          optional: true,
          relation: {
            opposite: "createdExamReports",
            name: "ExamReportCreator",
            fields: ["createdById"],
            references: ["id"],
            onDelete: "SetNull",
          },
    ...
    ExamReportSection: {
      ...
      fields: {
        ...
        examReportId: {
          name: "examReportId",
          type: "Int",
          foreignKeyFor: ["examReport"] as readonly string[],
        },
        sectionKey: {
          name: "sectionKey",
          type: "String",
    ...
    ExamReportReaction: {
      ...
      fields: {
        ...
        sectionId: {
          name: "sectionId",
          type: "Int",
          foreignKeyFor: ["section"] as readonly string[],
        },
        allergenId: {
          name: "allergenId",
          type: "String",
    ...
    ClinicSettings: {
      ...
      fields: {
        ...
        address: {
          ...
          type: "String",
          default:
            "San Mart\u00EDn 870, Edificio Caram, Torre B, Of. 208 A \u2013 208 B, Concepci\u00F3n" as FieldDefault,
        },
        phoneWhatsapp: {
          name: "phoneWhatsapp",
          type: "String",
    ...
    StockReservation: {
      ...
      fields: {
        ...
        cartId: {
          ...
          type: "Int",
          optional: true,
          foreignKeyFor: ["cart"] as readonly string[],
        },
        orderId: {
          name: "orderId",
          type: "Int",
