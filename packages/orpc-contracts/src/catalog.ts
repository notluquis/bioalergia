...
export const productCreateInputSchema = z.object({
  ...
  width_cm: z.number().int().nonnegative().nullable().optional(),
  height_cm: z.number().int().nonnegative().nullable().optional(),
  length_cm: z.number().int().nonnegative().nullable().optional(),
