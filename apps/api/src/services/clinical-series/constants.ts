...
export const LOWERCASE_NAME_STOPWORDS = new Set([
  ...
  "vino",
  "asistira",
  // --- Audit 2026-06-05: mined from leaked name tails (clinical_series) ---
  // Relationship markers: text after these is a relative, not the patient.
  // (mama/papa/hijo/hija/menor already above.) Breaking the name sequence
  // here drops the trailing relative name.
  "tutor",
  "tutora",
  "madre",
  "padre",
  ...
  "cuidadora",
  "responsable",
  // Medications / symptoms / conditions that leak from clinical notes.
  "inmunologico",
  "desloratadina",
  "loratadina",
  "clorfenamina",
  ...
  "constantes",
  "permanente",
  // Food allergens written as note tails.
  "soya",
  "mani",
  "leche",
  // Communes / regions (excluding ones that double as common surnames).
  "nuble",
  "coelemu",
  "angol",
  "bulnes",
