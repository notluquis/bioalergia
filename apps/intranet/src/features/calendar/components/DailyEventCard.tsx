...
export function DailyEventCard({ event, eventDteLink, onLinkClick }: DailyEventCardProps) {
  ...
  return (
    <Card className="group h-full border border-default-200 shadow-sm hover:shadow-md" data-phi-block>
      <div className="grid grid-cols-[auto_1fr_auto] gap-3 overflow-visible p-3 sm:gap-4 sm:p-4">
        ...
        <div className="min-w-0 space-y-1.5">
          {/* Title */}
          <h3 className="line-clamp-2 wrap-break-word font-semibold text-sm leading-tight sm:text-base">
