 ...
 * These are JSON serialized versions of WebAuthn types generated by the backend
 * See: @simplewebauthn/server (generateRegistrationOptions, generateAuthenticationOptions)
 */
...
export type PublicKeyCredentialRequestOptionsJSON = {
  ...
  allowCredentials?: Array<{
    id: string;
    type: "public-key";
    transports?: Array<"usb" | "nfc" | "ble" | "cable" | "internal" | "hybrid" | "smart-card">;
  }>;
  userVerification?: "required" | "preferred" | "discouraged";
  extensions?: Record<string, unknown>;
};
